...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $weeks = [
            ['id' => 1, 'name' => 'Понедельник', 'index' => '2'],
            ['id' => 2, 'name' => 'Вторник', 'index' => '3'],
            ['id' => 3, 'name' => 'Среда', 'index' => '4'],
            ['id' => 4, 'name' => 'Четверг', 'index' => '5'],
            ['id' => 5, 'name' => 'Пятница', 'index' => '6'],
            ['id' => 6, 'name' => 'Суббота', 'index' => '7'],
            ['id' => 7, 'name' => 'Воскресенье', 'index' => '1'],
        ];
