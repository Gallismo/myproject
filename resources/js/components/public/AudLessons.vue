    ...
    <div class="d-flex flex-column align-items-center">
        <div class="grid-1 grid-sm-2 grid-gap-1 w-100">
            <div class="form-group" id="search_container">
                ...
                <input type="text" id="audience" name="audience" v-debounce:400="search"
                       placeholder="Аудитория" class="form-control btn-secondary">
...
export default {
    ...
    methods: {
        ...
        selectRow(event) {
            ...
            $('input#audience').val(event.target.innerText);
            this.searchList = [];
            this.findLessons();
